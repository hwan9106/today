...
public class EX10_CreateParagraph3 {
	...
	private static float addParagraph( PDPageContentStream contentStream, PDFont font, float fontSize, float width, float startY, String text, int align) throws IOException {
