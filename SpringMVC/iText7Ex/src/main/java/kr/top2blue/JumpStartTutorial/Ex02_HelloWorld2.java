...
public class Ex02_HelloWorld2 {
	static String destFileName = "JumpStartTutorial/result/Ex02_HelloWorld2.pdf";
	...
	private static void makePdf(String fileName) {
		...
		try {
			...
			PdfFont font1 = PdfFontFactory.createFont(fontFile, PdfEncodings.IDENTITY_H);
			PdfFont font2 = PdfFontFactory.createFont(fontFile, PdfEncodings.IDENTITY_V);
			document.add(new Paragraph("반갑습니다. iText7!!!").setFont(font1)); // 문단 추가
			document.add(new Paragraph("반갑습니다. iText7!!!").setFont(font2)); // 문단 추가
