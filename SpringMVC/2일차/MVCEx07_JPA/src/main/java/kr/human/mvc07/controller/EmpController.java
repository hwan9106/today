package kr.human.mvc07.controller;
...
import kr.human.mvc07.service.EmpService;
...
public class EmpController {
	...
	public String updatePost(@ModelAttribute Emp empVO, @RequestParam(defaultValue = "0") int mode) {
		try {
			switch (mode) {
			case 0:
